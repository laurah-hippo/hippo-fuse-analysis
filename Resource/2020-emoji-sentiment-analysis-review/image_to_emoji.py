# takes the process-able image as input outputs the list of emojis as a list of np arrays <- Original explanation of the code

import cv2 # a module as part of OpenCV, an open-source computer vision library used for image processing, real-time computer vision applications, and machine learning tasks.
import statistics # a module that provides functions for calculating mathematical statistics of numeric data, such as mean, median, mode, variance, and standard deviation.
import numpy as np
from scipy.signal import find_peaks # finds peaks inside a signal based on peak properties. Finds all local maxima by simple comparison of neighboring values.
